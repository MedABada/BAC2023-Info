...
dateL=document.getElementById("dateLoc");
nbJr=document.getElementById("txt_nbJour");
function verif() 
{
    verif_matricule();
    verif_nom();
    verif_date(dateL.value);
}
    ...
    if (!isNaN(j) && !isNaN(m) && !isNaN(a)) 
        {
            ...
            {
                dateRetour = new Date (a, m, j);
                dateRetour.setDate(Number(nbJr.value)+dateRetour.getDate());
                console.log(dateRetour.getDate());
